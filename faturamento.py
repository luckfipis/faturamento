...
faturamentos = '''
{
    "dias": [
        ...
        {"dia": 5, "valor": 0.0},  # Feriado
        {"dia": 6, "valor": 26742.6612},
        {"dia": 7, "valor": 0.0},  # Fim de semana
...
faturamento = json.loads(faturamentos)
...
acimadamedia = len([valor for valor in valores if valor > mediamensal])

print(f"Menor valor de faturamento: R${menorfaturamento:.2f}")
print(f"Maior valor de faturamento: R${maiorfaturamento:.2f}")
print(f"Número de dias acima da média: {acimadamedia}")
